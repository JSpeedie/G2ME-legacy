...
if ((len(sys.argv) - 1) != 2):
    sys.exit('Usage: convchallonge.py link_to_bracket [output_file]')
...
# The dates probably get converted to ints at some point but i'm just gonna trim leading 0's off the month and day anyways
date[1] = date[1].lstrip('0')
date[2] = date[2].lstrip('0')

# Get participants of the tourney and built a simple dict of id: name
...
with open(outFile, 'w+') as f:
    for match in matches:
        ...
        # Should work if both numbers are negative but whose got time for testing
        if (scores[0] == '-'):
        ...
        line = '{} {} {} {} {} {} {}\n'
        f.write(line.format(m['p1Name'], m['p2Name'], m['p1Score'], m['p2Score'], date[2], date[1], date[0]))
